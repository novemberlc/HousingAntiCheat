# HousingAntiCheat
HousingAntiCheat is a Minecraft bot created to monitor parkour times and automatically ban players whose times are illegitimate

## Early Development Warning
This project is in early development. The current version may be working, but is not recommended to be used in production due to the unstable nature of early development projects.
